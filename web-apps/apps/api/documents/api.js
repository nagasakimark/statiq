...
this.frame.blur())};window.AscEmbed.initWorker=function(a){window.AscEmbed.workers=window.AscEmbed.workers||[];a=new b(a);window.AscEmbed.workers.push(a);return a}})();
    ...
    function getBasePath() {
        ...
        // Statiq Office: chart/diagram popups run inside an editor iframe that may
        // not have loaded api.js yet — derive the apps root from the page URL.
        var pathname = window.location.pathname || "";
        var webApps = pathname.indexOf("/web-apps/");
        if (webApps >= 0) {
            return pathname.slice(0, webApps + "/web-apps/apps/".length);
        }
        var base = window.__STATIQ_BASE_PATH__ || "";
        return base + (base ? "/web-apps/apps/" : "/web-apps/apps/");
    }
